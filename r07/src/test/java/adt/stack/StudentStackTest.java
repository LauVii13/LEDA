...
public class StudentStackTest {
	...
	private void getImplementations() {
		...
		stack3 = new StackImpl<>(20);
	}

	// MÉTODOS DE TESTE
	@Test
	public void testTop() {
		assertEquals(3, (int) stack1.top());
	}
	...
	public void testPushComErro() throws StackOverflowException {
		stack2.push(5); // levanta excecao apenas se o tamanhonao
	...
	public void testPopComErro() throws StackUnderflowException {
		assertEquals(3, (int) stack3.pop()); // levanta excecao apenas se
													// stack1 for vazia
	}
}